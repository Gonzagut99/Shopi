  ...
  return (
    <nav className='top-0 flex justify-between items-center fixed z-10 w-full py-5 px-8 text-sm font-light'>
        <ul className='flex items-center gap-3'>
            ...
            <li>
                <NavLink to='/clothes' className={({ isActive, isPending }) => {
                    return activeStyle(isActive, isPending)
            ...
            <li>
                <NavLink to='/furitures' className={({ isActive, isPending }) => {
                    return activeStyle(isActive, isPending)
            ...
            <li>
                <NavLink to='/toys' className={({ isActive, isPending }) => {
                    return activeStyle(isActive, isPending)
        ...
        <ul className='flex items-center gap-3'>
            ...
            <li>
                <NavLink to='/my-account' className={({ isActive, isPending }) => {
                    return activeStyle(isActive, isPending)
                }}>
                    MyAccount
                </NavLink>
